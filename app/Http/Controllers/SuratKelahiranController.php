...
class SuratKelahiranController extends Controller
{
    ...
    public function create()
    {
        ...
        $jumlah = AnggotaKK::where('no_kk', $no_kk)->count();
        return view('surat-kelahiran.create', compact('anggota', 'jumlah'));
    }
    ...
    {
        $surat = SuratKelahiran::find($id)->first();
        return view('surat-kelahiran.detail', compact('surat'));
    }
