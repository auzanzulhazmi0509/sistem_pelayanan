...
Route::get('/surat-pindah/cetak_pdf/{id}', [SuratPindahController::class, 'cetak_pdf'])->name('surat-pindah.cetak');
Route::get('/surat-penduduk/cetak_pdf/{id}', [SuratMenjadiPendudukController::class, 'cetak_pdf'])->name('surat-penduduk.cetak');
